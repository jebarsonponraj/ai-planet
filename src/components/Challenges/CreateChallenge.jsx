...
const CreateChallenge = () => {
  ...
  return (
    <div className="bg-white min-h-screen p-8">
      <h1 className="text-3xl font-bold mb-6">{formData.id ? 'Edit Challenge' : 'Create Challenge'}</h1>
      <form onSubmit={handleSubmit} className="space-y-4 w-full md:w-1/2">
        ...
        <div className="bg-[#F8F9FD] p-4 rounded">
          ...
          />
          {!formData.image && (
            <label htmlFor="image" className="p-2 border rounded cursor-pointer inline-flex items-center">
              <img
                src={upload}
                alt="Upload"
        ...
        <button type="submit" className="bg-[#44924C] text-white px-4 py-2 rounded">
