...
const initialHackathonsData = [
    {
      ...
      status: "Active",
      image: image1,
      description: "A beginner-friendly datathon designed to test your fundamental data science skills. Perfect for those who are just starting their data science journey."
    },
    {
      id: 2,
      ...
      status: "Active",
      image: image2,
      description: "An intermediate-level challenge focused on building machine learning models to identify different species of butterflies from images."
    },
    {
      id: 3,
      ...
      status: "Upcoming",
      image: image3,
      description: "A challenging datathon that requires participants to analyze and predict weather conditions using advanced data science techniques."
    },
    {
      id: 4,
      ...
      status: "Past",
      image: image4,
      description: "An entry-level datathon where you analyze passenger satisfaction data to predict and enhance the flying experience."
    },
    {
      id: 5,
      ...
      status: "Upcoming",
      image: image5,
      description: "An intermediate-level challenge focused on predicting the employment outcomes of engineering graduates based on academic and demographic data."
    },
    {
      id: 6,
      ...
      status: "Past",
      image: image6,
      description: "A high-difficulty datathon aimed at predicting the likelihood of travel insurance claims, requiring expertise in risk modeling and data analysis."
    }
  ];
...
const HackathonList = () => {
  ...
  useEffect(() => {
    ...
    if (storedHackathons) {
      ...
      localStorage.setItem('hackathonsData', JSON.stringify(initialHackathonsData));
    }
  }, []);
            ...
            {selectedFilters.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {selectedFilters.map(({ category, option }) => (
                  <div key={`${category}-${option}`} className="bg-[#7A8F9A] text-white rounded-full px-3 py-1 text-sm flex items-center">
                    {option}
                    <button
